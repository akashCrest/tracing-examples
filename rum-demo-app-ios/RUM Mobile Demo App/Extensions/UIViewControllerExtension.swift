...
extension UIViewController {
    ...
    func presentErrorAlertAndDismiss(title: String, message: String) {
        ...
        guard let titleFont = UIFont(name: config.fontNameRegular, size: config.largeLabelSize) else { return }
        guard let messageFont = UIFont(name: config.fontNameLight, size: config.midLargeLabelSize) else { return }
        alert.configure(titleFont: titleFont)
        alert.configure(titleColor: config.accentColor)
    ...
    func presentErrorAlertAndPop(title: String, message: String) {
    ...
    func presentErrorAlertWrongDetails(title: String, message: String) {
    ...
    func presentErrorAlertNetworkIssues() {
        
        let alert = PCLBlurEffectAlertController(title: "Networking error!", message: "Please check your connection and try again", effect: UIBlurEffect(style: .prominent) , style: .alertVertical)
    ...
    func presentErrorAlertInternalIssue() {
        let alert = PCLBlurEffectAlertController(title: "Internal error!", message: "Something went wrong, please try again", effect: UIBlurEffect(style: .prominent) , style: .alertVertical)
    ...
    func presentErrorAlertInternalIssuePopNav() {
        let alert = PCLBlurEffectAlertController(title: "Internal error!", message: "Something went wrong, please try again", effect: UIBlurEffect(style: .prominent) , style: .alertVertical)
    ...
    func presentTwoChoiceAlert(title: String, message: String, action1Msg: String, action2Msg: String) {
        let alert = PCLBlurEffectAlertController(title: title, message: message, effect: UIBlurEffect(style: .prominent) , style: .alertVertical)
        let action1 = PCLBlurEffectAlertAction(title: action1Msg, style: .default) { (delay) in
            
        }
        
        let action2 = PCLBlurEffectAlertAction(title: action2Msg, style: .default) { (delay) in
        }
        alert.configure(alertViewWidth: view.frame.width * 0.7)
        guard let titleFont = UIFont(name: config.fontNameRegular, size: config.largeLabelSize) else { return }
        guard let messageFont = UIFont(name: config.fontNameLight, size: config.midLargeLabelSize) else { return }
    ...
    func presentTransaction(title: String, message: String) {
        
        let alert = PCLBlurEffectAlertController(title: title, message: message, effect: UIBlurEffect(style: .prominent) , style: .alertVertical)
        let action1 = PCLBlurEffectAlertAction(title: "OK".localized(), style: .cancel) { (delay) in
        }
        
        alert.configure(alertViewWidth: view.frame.width * 0.8)
        guard let titleFont = UIFont(name: config.fontNameRegular, size: config.largeLabelSize) else { return }
        guard let messageFont = UIFont(name: config.fontNameLight, size: config.smallLabelSize) else { return }
        alert.configure(titleFont: titleFont)
        alert.configure(titleColor: config.accentColor)
