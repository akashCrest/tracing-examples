            ...
            if let countryName = country, !countryName.isEmpty {
                ...
                if countryName.lowercased() == "france" {
                    ...
                    DispatchQueue.main.async {
                        DataService.request(getURL(for: ApiName.GenerateSalesTax.rawValue), method: "GET", params: nil, shouldDisplayLoader: false, type: ProductDetail.self) { responseModel, errorMessage, responseCode in}
                    }
                } else {
